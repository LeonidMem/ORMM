...
public sealed abstract class AbstractUpdateQuery<O, T, R> extends AbstractQuery<T, R> permits UpdateQuery,
                                                                                              UpdateObjectQuery {
    ...
    protected AbstractUpdateQuery(@NotNull ORMTable<T> table, @Nullable T object) {
        super(table);
        this.object = object;
